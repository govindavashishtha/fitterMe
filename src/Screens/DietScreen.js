...
const DietScreen = ({setIsDiet}) => {
  ...
  const styles = StyleSheet.create({
    ...
    emptyText: {
      fontSize: 11,
      color: isDarkMode ? Colors.gray : Colors.charcoalGrey,
      paddingVertical: 7,
      textAlign: 'center',
      borderTopWidth: 0.5,
    ...
    <>
      ...
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {breakfast.length != 0 ? (
              <FlatList
                ...
                renderItem={({item}) => (
                  <MealCard
                    Item={item.item}
                    title={limitRecipeTitle(item.title)}
                    mealTime={'Breakfast'}
                    refresh={refresh}
                  />
                )}
          ...
          <View>
            <View
              style={{borderTopWidth: 2, borderColor: Colors.charcoalGrey}}
            />
            <Text style={styles.total}> Your Total Macros:</Text>
            <View style={styles.horizontal}>
              <Text style={styles.totalText}>Calories : {calorie} Kcal</Text>
            ...
            <View style={styles.horizontal}>
              ...
              <Text style={styles.totalText}>Fat : {fats.toFixed(2)} g</Text>
            </View>
          </View>
        </ScrollView>
      </View>
