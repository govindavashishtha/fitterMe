...
const CaloriesCard = ({Item}) => {
  ...
  const styles = StyleSheet.create({
    container: {
      borderWidth: 1,
      borderRadius: 10,
      borderColor: isDarkMode ? Colors.textColorDark : Colors.charcoalGrey80,
      padding: 20,
      width: '70%',
      alignItems: 'baseline',
  ...
  return (
    <>
      <View style={styles.container}>
        {Item.calories ? (
          <Text style={styles.text}>Total Calories : {Item.calories} Kcal</Text>
        ) : null}
        ...
        {Item.totalNutrients.K ? (
          <Text style={styles.text1}>
            {Item.totalNutrients.K.label} :{' '}
            {Item.totalNutrients.K.quantity.toFixed(2)}{' '}
            {Item.totalNutrients.K.unit}
          </Text>
        ) : (
          <></>
        )}
        {Item.totalNutrients.MG ? (
          <Text style={styles.text1}>
            {Item.totalNutrients.MG.label} :{' '}
            {Item.totalNutrients.MG.quantity.toFixed(2)}{' '}
        ...
        {Item.totalNutrients.NA ? (
          <Text style={styles.text1}>
            ...
            {Item.totalNutrients.NA.quantity.toFixed(2)}{' '}
            {Item.totalNutrients.NA.unit}
          </Text>
        ) : (
          <></>
        )}
        {Item.totalNutrients.ZN ? (
          <Text style={styles.text1}>
            {Item.totalNutrients.ZN.label} :{' '}
            {Item.totalNutrients.ZN.quantity.toFixed(2)}{' '}
            {Item.totalNutrients.ZN.unit}
          </Text>
        ) : (
          <></>
        )}
        {Item.totalNutrients.P ? (
          <Text style={styles.text1}>
            {Item.totalNutrients.P.label} :{' '}
            {Item.totalNutrients.P.quantity.toFixed(2)}{' '}
        ...
        {Item.totalNutrients.VITA_RAE ? (
          <Text style={styles.text1}>
            {Item.totalNutrients.VITA_RAE.label} :{' '}
            {Item.totalNutrients.VITA_RAE.quantity.toFixed(2)}{' '}
            {Item.totalNutrients.VITA_RAE.unit}
          </Text>
        ) : (
          <></>
        )}
        {Item.totalNutrients.VITC ? (
          <Text style={styles.text1}>
            {Item.totalNutrients.VITC.label} :{' '}
            {Item.totalNutrients.VITC.quantity.toFixed(2)}{' '}
            {Item.totalNutrients.VITC.unit}
          </Text>
        ) : (
          <></>
        )}
        {Item.totalNutrients.VITD ? (
          <Text style={styles.text1}>
            {Item.totalNutrients.VITD.label} :{' '}
            {Item.totalNutrients.VITD.quantity.toFixed(2)}{' '}
            {Item.totalNutrients.VITD.unit}
          </Text>
        ) : (
          <></>
        )}
        {Item.totalNutrients.TOCPHA ? (
          <Text style={styles.text1}>
            {Item.totalNutrients.TOCPHA.label} :{' '}
            {Item.totalNutrients.TOCPHA.quantity.toFixed(2)}{' '}
